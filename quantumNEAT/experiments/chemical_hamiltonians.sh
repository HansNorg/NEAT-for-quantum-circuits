...
bash experiments/run_experiment_lorentz_n_shots.bash gs_h2_errorless_saveh linear_growth -N 2 -O 100 -G 20 -R 11 
bash experiments/run_experiment_lorentz_n_shots.bash gs_h6_errorless_saveh linear_growth -N 6 -O 100 -G 20 -R 11

bash experiments/run_experiment_lorentz_n_shots.bash gs_h2_errorless_saveh linear_growth -N 2 -O 100 -G 20 -R 11 --phys_noise
bash experiments/run_experiment_lorentz_n_shots.bash gs_h6_errorless_saveh linear_growth -N 6 -O 100 -G 20 -R 11 --phys_noise