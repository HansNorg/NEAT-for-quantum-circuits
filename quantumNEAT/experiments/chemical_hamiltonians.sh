...
bash experiments/run_experiment_single_cpu_long.bash gs_h6_errorless_saveh linear_growth -N 6 -O 100 -G 20 -R 8 --phys_noise # Mixed -> TimeOut Run 3 Gen 18
bash experiments/run_experiment_single_cpu_long.bash gs_lih_errorless_saveh linear_growth -N 8 -O 100 -G 20 --phys_noise # Failed -> TimeOut Gen 10
bash experiments/run_experiment_single_cpu_long.bash gs_lih_errorless_saveh linear_growth -N 8 -O 100 -G 20 --phys_noise # Failed -> TimeOut Gen 10
...
bash experiments/run_experiment_single_cpu_long.bash gs_h6_errorless_saveh linear_growth -N 6 -O 100 -G 20 -R 8 --phys_noise --total_energy # Mixed -> TimeOut Run 3 Gen 13
bash experiments/run_experiment_single_cpu_long.bash gs_lih_errorless_saveh linear_growth -N 8 -O 100 -G 20 --phys_noise --total_energy # Failed -> TimeOut Gen 10
bash experiments/run_experiment_single_cpu_long.bash gs_lih_errorless_saveh linear_growth -N 8 -O 100 -G 20 --phys_noise --total_energy
...
bash experiments/run_experiment_single_cpu.bash gs_h6_errorless_saveh linear_growth -N 6 -O 100 -G 100 -R 2 --total_energy # Mixed -> TimeOut Run 9 Gen 25
bash experiments/run_experiment_single_cpu.bash gs_lih_errorless_saveh linear_growth -N 8 -O 100 -G 100 -R 3 --total_energy # Mixed -> TimeOut Run 8 Gen 28
...
bash experiments/run_experiment_single_cpu.bash gs_lih_errorless_saveh linear_growth -N 8 -O 100 -G 100 -R 2 # Mixed -> TimeOut Run 9 Gen 44
...
bash experiments/run_experiment_single_cpu_long.bash gs_h6_errorless_saveh linear_growth -N 6 -O 100 -G 20 -R 8 --phys_noise --fitness_sharing # Mixed -> TimeOut Run 3 Gen 19
bash experiments/run_experiment_single_cpu_long.bash gs_lih_errorless_saveh linear_growth -N 8 -O 100 -G 20 --phys_noise --fitness_sharing # Failed -> TimeOut Gen 9
bash experiments/run_experiment_single_cpu_long.bash gs_lih_errorless_saveh linear_growth -N 8 -O 100 -G 20 --phys_noise --fitness_sharing # Failed -> TimeOut Gen 9

bash experiments/run_experiment_single_cpu.bash gs_h2_errorless_saveh linear_growth -N 2 -O 100 -G 20 -R 6 --phys_noise --total_energy --fitness_sharing # Mixed -> ValueError Run 5 Gen 16
bash experiments/run_experiment_single_cpu_long.bash gs_h6_errorless_saveh linear_growth -N 6 -O 100 -G 20 -R 10 --phys_noise --total_energy --fitness_sharing # Mixed -> TimeOut Run 3 Gen 14
bash experiments/run_experiment_single_cpu_long.bash gs_lih_errorless_saveh linear_growth -N 8 -O 100 -G 20 --phys_noise --total_energy --fitness_sharing # Failed -> TimeOut Gen 9
