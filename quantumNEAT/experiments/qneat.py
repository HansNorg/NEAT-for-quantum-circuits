...
def run_multiple_empty(n_qubits, population_size, n_generations, folder = "quantumneat", n_runs = 10):
    config = Config(n_qubits, population_size, initial_layers=0)
...
if __name__ == "__main__":
    ...
    run_multiple_empty(n_qubits=5, population_size=100, n_generations=1000, folder = ".", n_runs=10)